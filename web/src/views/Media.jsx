    ...
    return (
      ...
      >
        ...
        <span style={{ display: "flex", alignItems: "center", gap: 4, flex: "0 0 auto", position: "relative", minWidth: 48, justifyContent: "flex-end" }}>
              <span style={{ fontSize: 11, color: "var(--muted)", whiteSpace: "nowrap", marginRight: 6, transform: hoveredPlId === pl.id ? "translateX(-52px)" : "translateX(0)", transition: "transform .15s" }}>{count}</span>
